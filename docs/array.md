...
```
import { OrderByPipe } from 'angular-pipes/pipes/src/array/order-by.pipe';
```
...
```
import { ReversePipe } from 'angular-pipes/pipes/src/array/reverse.pipe';
```
...
```
import { CountPipe } from 'angular-pipes/pipes/src/array/count.pipe';
```
...
```
import { SomePipe } from 'angular-pipes/pipes/src/array/some.pipe';
```
...
```
import { EveryPipe } from 'angular-pipes/pipes/src/array/every.pipe';
```
